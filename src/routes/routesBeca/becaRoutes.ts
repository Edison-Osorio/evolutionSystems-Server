...
class BecaRoutes {
    ...
    config(): void {
        ...
        this.router.get('/alumno/alumno_beca/:id_alumno', becaController.getBecaAlumno)
        ...
        this.router.delete('/delete-alumno-beca/:id_alumno', becaController.deleteBecaAlumnosAlumno)
